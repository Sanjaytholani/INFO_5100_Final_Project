...
public class PatientFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Appointment Number", "Doctor", "Status", "Prescription"
            }
        ));
    ...
    public void setPatient(String patient){
        try{
            ...
            String sql = "SELECT * FROM AED_Final_Project.appointment WHERE patient='"+patient+"';";
            ...
            while(rs.next()){
                ...
                String tbData[] = {appointment,doctor,status,prescription};
